...
bend_arr = [0.000001,5:5:90];% array of values for the varying parameter
roll_arr = 0:5:75; % array of the "roll" rotation (deg)
pitch_arr = pitch_range(1):5:pitch_range(end);% array of the "pitch" rotation (deg)
