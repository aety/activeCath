...
bend_arr = [0.000001,5:5:65];% array of values for the varying parameter
roll_arr = -25:5:20; % array of the "roll" rotation (deg)
pitch_arr = pitch_range(1):5:pitch_range(2);% array of the "pitch" rotation (deg)
