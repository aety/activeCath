...
for bb = 1:length(pitch_arr)
    ...
    for aa = 1:length(roll_arr)
        ...
        for rr = 1:length(bend_arr)
            ...
            X_PKS_ARR{aa,rr,bb} = x_pks;
            Y_PKS_ARR{aa,rr,bb} = y_pks;
            X_ARR{aa,rr,bb} = X; Y_ARR{aa,rr,bb} = Y; Z_ARR{aa,rr,bb} = Z;
            XH_ARR{aa,rr,bb} = xh; YH_ARR{aa,rr,bb} = yh; ZH_ARR{aa,rr,bb} = zh;
...
save catheter_simulator_findApex *_ARR *_arr p1_helix p2_helix npt_helix a_helix n_helix L L_res L_pct_bent